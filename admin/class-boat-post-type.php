...
class Easy_Boats_Boat_Post_Type {
    ...
    public function register_boat_type_taxonomy() {
        ...
        $labels = array(
            ...
            'all_items'                  => __( 'All Types', 'easy-boats' ),
            'parent_item'                => __( 'Parent Type', 'easy-boats' ),
            'parent_item_colon'          => __( 'Parent Type:', 'easy-boats' ),
            'new_item_name'              => __( 'New Type Name', 'easy-boats' ),
            'add_new_item'               => __( 'Add New Type', 'easy-boats' ),
            'edit_item'                  => __( 'Edit Type', 'easy-boats' ),
            'update_item'                => __( 'Update Type', 'easy-boats' ),
            'view_item'                  => __( 'View Type', 'easy-boats' ),
            'separate_items_with_commas' => __( 'Separate Types with commas', 'easy-boats' ),
            'add_or_remove_items'        => __( 'Add or remove Types', 'easy-boats' ),
            'choose_from_most_used'      => __( 'Choose from the most used', 'easy-boats' ),
            'popular_items'              => __( 'Popular Types', 'easy-boats' ),
            'search_items'               => __( 'Search Types', 'easy-boats' ),
            'not_found'                  => __( 'Not found', 'easy-boats' ),
        );
    ...
    public function register_boat_hull_type_taxonomy() {
        ...
        $labels = array(
            ...
            'all_items'                  => __( 'All Hull Types', 'easy-boats' ),
            'parent_item'                => __( 'Parent Hull Type', 'easy-boats' ),
            'parent_item_colon'          => __( 'Parent Hull Type:', 'easy-boats' ),
            'new_item_name'              => __( 'New Hull Type Name', 'easy-boats' ),
            'add_new_item'               => __( 'Add New Hull Type', 'easy-boats' ),
            'edit_item'                  => __( 'Edit Hull Type', 'easy-boats' ),
            'update_item'                => __( 'Update Hull Type', 'easy-boats' ),
            'view_item'                  => __( 'View Hull Type', 'easy-boats' ),
            'separate_items_with_commas' => __( 'Separate Hull Types with commas', 'easy-boats' ),
            'add_or_remove_items'        => __( 'Add or remove Hull Types', 'easy-boats' ),
            'choose_from_most_used'      => __( 'Choose from the most used', 'easy-boats' ),
            'popular_items'              => __( 'Popular Hull Types', 'easy-boats' ),
            'search_items'               => __( 'Search Hull Types', 'easy-boats' ),
            'not_found'                  => __( 'Not Found', 'easy-boats' ),
        );
